...
class _PropertiesByTypeScreenState extends State<PropertiesByTypeScreen> {
  ...
  void didChangeDependencies() {
    if (_isInit) {
      Provider.of<PropertiesProvider>(context, listen: false).clearByTypeData();
      _data = Provider.of<PropertiesProvider>(context, listen: false)
          .getPropertiesByType(typeID: widget.id, page: currentPage);
      _isInit = false;
    }
                ...
                if (snapshot.connectionState == ConnectionState.waiting) {
                  ...
                  return Consumer<PropertiesProvider>(
                    builder: (context, value, _) {
                      if (value.propertiesByType.isEmpty) {
                        return Padding(
                      ...
                      sortBy == 0 ? value.sortByPopular(false, false) : null;
                      sortBy == 1 ? value.sortByNewest(false, false) : null;
                      sortBy == 2
                          ? value.sortByPriceLowest(false, false)
                          : null;
                      sortBy == 3
                          ? value.sortByPriceHighest(false, false)
                          : null;
                      return Column(
                        children: [
                          SizedBox(
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  //     child: Text(
                                  //         "${value.totalProperties.toString()} properties")),
                                  //
                                  //Sort
                                  //
                                  GestureDetector(
                          ...
                          ListView.builder(
                              ...
                              itemCount: value.propertiesByType.length,
                              itemBuilder: (ctx, index) {
                                return ListViewWidget(
                                  id: value.propertiesByType[index].id,
                                  propertyName:
                                      value.propertiesByType[index].name,
                                  price: value.propertiesByType[index].price,
                                  bedroom: value
                                      .propertiesByType[index].details.bedroom,
                                  bathroom: value
                                      .propertiesByType[index].details.bathroom,
                                  area: value
                                      .propertiesByType[index].details.area,
                                  address: value
                                      .propertiesByType[index].address.city,
                                  type: value
                                      .propertiesByType[index].propertyType,
                                  imgUrl: value
                                      .propertiesByType[index].images[0].url,
                                );
                              }),
                        ],
                      );
