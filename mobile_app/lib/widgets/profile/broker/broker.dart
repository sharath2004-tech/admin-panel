...
import 'package:real_estate/controllers/chat.dart';
...
class BrokerProfileWidget extends StatefulWidget {
  const BrokerProfileWidget({super.key});

  @override
  State<BrokerProfileWidget> createState() => _BrokerProfileWidgetState();
}

class _BrokerProfileWidgetState extends State<BrokerProfileWidget> {
  @override
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                //           arguments: value.user[0].broker),
                //       child: const ViewMyWidget(
                //         icon: Icons.settings,
                //         title: "Subscription",
                //       ),
                //     ),
