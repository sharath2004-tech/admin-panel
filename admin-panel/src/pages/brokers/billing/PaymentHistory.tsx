...
const PaymentHistory: React.FC = () => {
  ...
  const BrokersPropertyData = useFetchData(
    ["BrokersPaymentHistoryDataApi", currentPage, perPage, stateChange],
    `payment/broker/all/${user?.broker}?page=${currentPage}&perPage=${perPage}`,
    headers
  );
  return (
    <div className="p-3 bg-white dark:bg-secondary-dark-bg my-transition flex flex-col items-start space-y-3 w-full">
      <HeaderContainer headerTitle="Billing History"></HeaderContainer>
