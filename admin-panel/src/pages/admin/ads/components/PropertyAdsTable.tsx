...
const PropertyAdsTable: React.FC<TableProps> = ({
  data,
  setCurrentPage,
  setPerPage,
}) => {
  ...
  const PropertyTableColumns: ColumnDef<FeaturedProperty>[] = [
    ...
    },
    {
      ...
      header: () => {
        return <Button variant="ghost">viewCount</Button>;
      },
      cell: ({ row }) => {
        return (
          <h4 className="font-medium capitalize dark:text-gray-300">
    ...
    },
    {
      ...
      header: () => {
        return <Button variant="ghost">number Of Views</Button>;
      },
      cell: ({ row }) => {
        return (
          <h4 className="font-medium capitalize dark:text-gray-300">
    ...
    },
    {
      ...
      header: () => {
        return <Button variant="ghost">is Ended</Button>;
      },
      cell: ({ row }) => {
        return (
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuItem
                ...
                onClick={() =>
                  navigate(
                    `/requests/featured-property/detail/${row.original?._id}`
                  )
                }
              >
                View detail
...
export default PropertyAdsTable;
