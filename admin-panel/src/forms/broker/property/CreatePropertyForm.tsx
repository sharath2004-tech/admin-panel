  ...
  return (
    <>
      {packageStatusData?.data?.package ? (
        packageStatusData?.data?.package?.remining < 1 ? (
          <div className="w-full p-2 bg-[#f9be33] text-start rounded-md mb-1">
            <p className="text-gray-300 font-normal text-sm">
              You have finished your listing qouta to post property please buy
              package to list properties?{" "}
              <span
      ...
      ) : packageStatusData?.data?.freeListingQuotaRemaining < 1 ? (
        <div className="w-full p-2 bg-[#f9be33] text-start rounded-md mb-1">
          <p className="text-gray-300 font-normal text-sm">
            You have no free listing qouta to post property please buy package
            to list properties?{" "}
            <span
              onClick={() => navigate("/packages")}
              className="cursor-pointer font-medium hover:underline"
                              ...
                              <div className="w-full flex flex-col items-start space-y-1">
                                <CreatableCustomSelect
                                  ...
                                  options={nearByFacility.filter(
                                    (item) =>
                                      !addedFacility.includes(item.value)
                                  )}
